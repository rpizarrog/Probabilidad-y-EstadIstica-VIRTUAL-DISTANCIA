...
- ¿Para qué se puede utlizar la distribución *t student*?
- ¿Cómo obtener el valor de t crítico ?
- ¿Que valores se obtienen con la función *rt()*?
- ¿Para que sirve la función *dt()*?
- ¿Para que sirve la función *pt*?
