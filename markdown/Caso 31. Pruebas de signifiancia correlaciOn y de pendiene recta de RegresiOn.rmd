...
con media $\bar{x}=50$ y desviación estándar $S=5$, la segunda con con
...
Al estar en zona de aeptación se acepta la $H_0$.
...
Por lo anterior, tal vez nos serían datos para una modelo de regresión
simple, sin embargo se va a genera el modelo.
