...
Antes de continuar con los números pares, se presenta un ejercicio para probar la función *which()*.

La función *which()* devuelve la posición o *índice (index) de un elemento dentro de un vector*, ejemplo de *which*(). Ejemplo se tienen 12 números:
