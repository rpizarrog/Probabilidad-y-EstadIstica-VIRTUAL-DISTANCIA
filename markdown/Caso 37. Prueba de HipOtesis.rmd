---
title: "Caso 37. Prueba de Hipótesis para medias"
...
```{r}
z <- f.devolver.z.prueba(media.m = media.m, media.p = media.p, desv.p = desv.p, n = n)
z
...
Se definen un nivel de confiazna del 95%
...
### Prueba de hipótesis de una cola z
